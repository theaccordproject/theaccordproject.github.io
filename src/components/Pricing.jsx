      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="max-w-2xl mb-12">
          ...
          <p className="text-muted-brown leading-relaxed mt-5">
            Payments &amp; Invoicing is included as a free website feature. No forced bundles or large plans.
            Activate only the interactive modules your business actually uses, and
        ...
        <div className="grid lg:grid-cols-[1fr_320px] gap-10 items-start">
          <div className="border-t border-mid-sand">
            {modules.map(([icon, name, description, price]) => (
              <article key={name} className="flex gap-4 py-6 border-b border-mid-sand/70">
          ...
          <aside className="bg-warm-white border border-mid-sand/70 rounded-2xl p-7">
            <p className="eyebrow">A LITTLE GOES A LONG WAY</p>
            <h3 className="text-2xl tracking-tight font-semibold mt-4 mb-6">
              Your business.
              <br />
              Your combination.
            </h3>
            ...
            <div className="mt-7 pt-6 border-t border-mid-sand">
              ...
              <p className="text-xs text-muted-brown mt-3 leading-relaxed">
                Every module is optional. Payments &amp; Invoicing is a free website feature, included with every combination.
              </p>
            </div>
