...
export default function WebsiteGraphic() {
  return (
    <figure
      ...
      aria-label="Illustration of a business website and its private management portal"
    >
      ...
      <figcaption className="text-[11px] text-muted-brown text-right mt-4">
        An illustration of the TAP Business experience.
      </figcaption>
    </figure>
  )
}
